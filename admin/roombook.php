...
<?php
						...
						{	
							...
							if($st=="Conform")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Sorry! Not Available De Versierde Kamer ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available De Avonden Kamer')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available De Donkere Kamer')</script>";
									}
										else if($f4=="NO")
										{
										echo "<script type='text/javascript'> alert('Sorry! Not Available De Derde Kamer')</script>";
										}
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														if($troom=="De Versierde Kamer")
														{
															$type_of_room = 320;
														
														}
														else if($troom=="De Derde Kamer")
														{
															$type_of_room = 220;
														}
														else if($troom=="De Avonden Kamer")
														{
															$type_of_room = 180;
														}
														else if($troom=="De Donkere Kamer")
														{
															$type_of_room = 150;
														}
