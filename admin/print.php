...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									else if($troom=="De Versierde Kamer")
									{
										$type_of_room = 90;
									}
									...
									else if($troom=="De Opperlandse Kamer")
									{
										$type_of_room = 130;
									}
									else if($troom=="De Driestuivers Kamer")
									{
										$type_of_room = 75;
									}
									else if($troom=="De Geheime Kamer")
									{
										$type_of_room = 100;
									}
	...
	?>
		<header>
			...
			<address >
				<p>Jemeppe,</p>
				<p>Kasteelplein 1,<br>55701 PP,<br>Helmond.</p>
				<p>(+31) 6 19173220</p>
			</address>
		</header>
		<article>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@jemeppe.com || Web :- www.jemeppe.com || Phone :- +31 6 19173220</p>
			</div>
		</aside>
	</body>
</html>
